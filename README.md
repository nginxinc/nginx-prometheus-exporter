...
- To export NGINX metrics, run:
    ...
    ```console
    docker run -p 9113:9113 nginx/nginx-prometheus-exporter:1.1.1 --nginx.scrape-uri=http://<nginx>:8080/stub_status
    ```
...
- To export NGINX Plus metrics, run:
    ...
    ```console
    docker run -p 9113:9113 nginx/nginx-prometheus-exporter:1.1.1 --nginx.plus --nginx.scrape-uri=http://<nginx-plus>:8080/api
    ```
